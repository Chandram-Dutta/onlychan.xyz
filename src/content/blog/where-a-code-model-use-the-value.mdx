...
The last post left a hole in it. I probed four sizes of Qwen2.5-Coder and found that a small, linear
...
The tool for this is activation patching: change one piece of the model's internal state mid-run and
...
and the logit of the digits, and their difference is a number that's high when the model thinks the
...
That's the linearity claim: the part of the sign the model acts on is a single axis at one token. But
